...
install_xcframework "${PODS_ROOT}/MapboxCoreMaps/MapboxCoreMaps.xcframework" "MapboxCoreMaps" "framework" "ios-arm64" "ios-x86_64-maccatalyst" "ios-arm64_x86_64-simulator"
