...
/**
 * @brief A region's status includes its active/inactive state as well as counts
...
/** @brief Describes the download state */
@property (nonatomic, readonly) MBMOfflineRegionDownloadState downloadState;

/**
 * @brief The number of resources that have been fully downloaded and are ready for
 * offline access.
 */
@property (nonatomic, readonly) uint64_t completedResourceCount;

/**
 * @brief The cumulative size, in bytes, of all resources (inclusive of tiles) that have
 * been fully downloaded.
 */
@property (nonatomic, readonly) uint64_t completedResourceSize;

/**
 * @brief The number of tiles that are known to be required for this region. This is a
 * subset of `completedResourceCount`.
 */
@property (nonatomic, readonly) uint64_t completedTileCount;

/** @brief The number of tiles that are known to be required for this region. */
@property (nonatomic, readonly) uint64_t requiredTileCount;

/**
 * @brief The cumulative size, in bytes, of all tiles that have been fully downloaded.
 * This is a subset of `completedResourceSize`.
 */
@property (nonatomic, readonly) uint64_t completedTileSize;

/**
 * @brief The number of resources that are known to be required for this region. See the
...
/**
 * @brief This property is true when the value of requiredResourceCount is a precise
