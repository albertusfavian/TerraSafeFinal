...
/** @brief A rectangular area as measured on a two-dimensional map projection. */
...
/**
 * If set to true, an infinite (unconstrained) \p bounds covering the world coordinates would be used.
 * Coordinates provided in \p southwest and northeast fields would be omitted and have no effect.
 */
