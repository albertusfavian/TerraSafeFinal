...
/**
 * @brief Describes the image content, e.g. where text can be fit into an image.
 *
...
/** @brief Distance to the left, in screen pixels. */
@property (nonatomic, readonly) float left;

/** @brief Distance to the top, in screen pixels. */
@property (nonatomic, readonly) float top;

/** @brief Distance to the right, in screen pixels. */
@property (nonatomic, readonly) float right;

/** @brief Distance to the bottom, in screen pixels. */
