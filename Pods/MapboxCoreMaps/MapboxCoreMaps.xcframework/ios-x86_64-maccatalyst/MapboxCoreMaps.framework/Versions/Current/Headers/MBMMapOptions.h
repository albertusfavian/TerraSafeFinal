...
/** @brief Describes the map option values. */
...
/**
 * @brief The map context mode. This can be used to optimizations
...
/**
 * @brief The map constrain mode. This can be used to limit the map
...
/**
 * @brief The viewport mode. This can be used to flip the vertical
...
/**
 * @brief The orientation of the Map. By default, it is set to
 * Upwards.
 */
...
/**
 * @brief With terrain on, if `true`, the map will render for performance
...
/**
 * @brief The size to resize the map object and renderer backend.
...
/** @brief The custom pixel ratio. By default, it is set to 1.0 */
