...
/**
 * @brief ProjectedMeters is a coordinate in a specific Spherical Mercator projection.
 *
...
/** @brief Projected meters in north direction */
@property (nonatomic, readonly) double northing;

/** @brief Projected meters in east direction */
