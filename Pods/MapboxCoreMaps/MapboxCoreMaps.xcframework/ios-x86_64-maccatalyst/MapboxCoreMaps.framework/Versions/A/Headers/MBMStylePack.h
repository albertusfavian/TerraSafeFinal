...
/** @brief StylePack represents a stored style package. */
...
/** @brief The style associated with the style package */
@property (nonatomic, readonly, nonnull, copy) NSString *styleURI;

/**
 * @brief The glyphs rasterization mode of the style package.
 *
...
/**
 * @brief The cumulative size, in bytes, of all resources that have
 * been fully downloaded.
 */
@property (nonatomic, readonly) uint64_t completedResourceSize;

/**
 * @brief The earliest point in time when any of the style package resources gets expired.
 *
