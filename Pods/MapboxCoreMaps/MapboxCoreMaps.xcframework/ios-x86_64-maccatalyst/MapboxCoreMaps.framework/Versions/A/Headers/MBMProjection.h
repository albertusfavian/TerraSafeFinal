...
/**
 * @brief Collection of Spherical Mercator projection methods
...
/**
 * @brief Calculate distance spanned by one pixel at the specified latitude
 * and zoom level.
 *
...
+ (double)getMetersPerPixelAtLatitudeForLatitude:(double)latitude
                                            zoom:(double)zoom;
/**
 * @brief Calculate Spherical Mercator ProjectedMeters coordinates.
 *
...
/**
 * @brief Calculate a longitude-latitude pair for a Spherical Mercator projected
 * meters.
 *
...
/**
 * @brief Calculate a point on the map in Mercator Projection for a given
...
/**
 * @brief Calculate a coordinate for a given point on the map in Mercator Projection.
 *
