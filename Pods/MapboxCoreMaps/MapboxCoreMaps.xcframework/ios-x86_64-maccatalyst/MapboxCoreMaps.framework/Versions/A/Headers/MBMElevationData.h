...
/** @brief Interface that provides access to elevation data. */
NS_SWIFT_NAME(ElevationData)
@protocol MBMElevationData
/**
 * @brief Get elevation for given coordinate. Value is available only for the visible region on the screen, if terrain (DEM) tile is available.
 *
...
/** @brief Current value of terrain exaggeration. */
