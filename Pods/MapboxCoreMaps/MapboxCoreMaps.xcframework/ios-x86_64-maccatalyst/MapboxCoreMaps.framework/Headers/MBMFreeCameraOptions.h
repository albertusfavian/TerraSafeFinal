...
/**
 * @brief Various options for accessing physical properties of the underlying camera entity.
...
/**
 * @brief Get the position of the camera in slightly modified web mercator coordinates
...
/**
 * @brief Set the position of the camera in slightly modified web mercator coordinates
 *   - The size of 1 unit is the width of the projected world instead of the "mercator meter".
 *     Coordinate [0, 0, 0] is the north-west corner and [1, 1, 0] is the south-east corner.
 *   - Z coordinate is conformal and must respect minimum and maximum zoom values.
 *   - Zoom is automatically computed from the altitude (z)
...
/**
 * @brief Get the orientation of the camera represented as a unit quaternion [x, y, z, w].
...
/**
 * @brief Set the orientation of the camera represented as a unit quaternion [x, y, z, w].
 *   The default pose of the camera is such that the forward vector is looking up the -Z axis and
 *   the up vector is aligned with north orientation of the map:
 *     forward: [0, 0, -1]
 *     up:      [0, -1, 0]
...
/**
 * @brief Helper function for setting the mercator position as Lat&Lng and altitude in meters
 *
...
/**
 * @brief Helper function for setting orientation of the camera by defining a focus point.
 *        Elevation of 0.0 is used and no up vector.
 * @param location The focal point.
 */
...
/**
 * @brief Helper function for setting the orientation of the camera as a pitch and a bearing.
 *
