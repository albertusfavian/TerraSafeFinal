...
/** @brief Describes the style package load option values. */
...
/** @brief The style associated with the tileset descriptor */
@property (nonatomic, readonly, nonnull, copy) NSString *styleURI;

/**
 * @brief Minimum zoom level for the tile package.
 *
...
/**
 * @brief Maximum zoom level for the tile package
 *
 * maxZoom value cannot exceed the maximum allowed tile batch zoom value,
 * @see TilePackDefinition::minZoom
 */
@property (nonatomic, readonly) uint8_t maxZoom;

/**
 * @brief Pixel ratio to be accounted for when downloading raster tiles
 *
...
/**
 * @brief Style package load options, associated with the tileset descriptor.
 *
 * If provided, OfflineManager will create a style package while resolving the corresponding
 ...
 * package but the loaded resources will be stored in the ambient cache.
 */
