...
/**
 * @brief Specifies glyphs rasterization mode.
 *
...
/**
 * @brief A custom Mapbox Value associated with this style package for storing metadata.
 *
...
/**
 * @brief Accepts expired data when loading style resources.
 *
