...
/**
 * @brief TransitionOptions controls timing for the interpolation between a transitionable style
...
/** @brief Time allotted for transitions to complete. Units in milliseconds. Defaults to 300. */
@property (nonatomic, readonly, nullable) NSNumber *duration NS_REFINED_FOR_SWIFT;

/** @brief Length of time before a transition begins. Units in milliseconds. Defaults to 0. */
@property (nonatomic, readonly, nullable) NSNumber *delay NS_REFINED_FOR_SWIFT;

/** @brief Whether the fade in/out symbol placement transition is enabled. Defaults to true. */
