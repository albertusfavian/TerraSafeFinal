 ...
 * This method is called if underlying map rendering backend uses Metal graphic API.
 *
 * @param parameters Parameters that define the current camera position.
 * @param mtlCommandBuffer MTLCommandBuffer used to render all map layers.
 ...
 * to be encoded.
 * @param mtlRenderPassDescriptor render pass descriptor that defines rendering
 * map to view drawable.
 *
 */
