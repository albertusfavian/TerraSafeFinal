...
/** @brief An offline region represents an identifiable geographic region with optional metadata. */
...
/** @brief The regions identifier */
- (int64_t)getIdentifier;
/**
 * @brief The tile pyramid defining the region. Tile pyramid and geometry definitions are
 * mutually exclusive.
 *
...
/**
 * @brief The geometry defining the region. Geometry and tile pyramid definitions are
 * mutually exclusive.
 *
...
/**
 * @brief Register an observer to be notified when the state of the region changes.
 *
