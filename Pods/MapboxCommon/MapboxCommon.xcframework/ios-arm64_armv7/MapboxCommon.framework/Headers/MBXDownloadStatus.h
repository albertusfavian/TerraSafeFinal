...
/**
 * Currently not implemented, value is always zero. Amount of bytes received during the current resume attempt. For
 * downloads that weren't resumed, this value will be the same as receivedBytes.
 */
